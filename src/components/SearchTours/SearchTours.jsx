...
const SearchTours = () => {
  ...
  const retriesForThisCountry = emptyRetriesByCountry?.[countryID];
  const disableSubmit =
    isLoading || (typeof retriesForThisCountry === 'number' && retriesForThisCountry <= 0);
    ...
    <div className={styles.searchContainer}>
      ...
      <form onSubmit={handleSubmit} className={styles.searchForm}>
        <label className={styles.formLabel}>
          Виберіть країну:
          <select value={countryID} onChange={handleCountryChange} className={styles.selectInput}>
        ...
        <button type="submit" className={styles.submitButton} disabled={disableSubmit}>
          Знайти тури
        </button>
      </form>
